---
name: new-project
description: Initialize a new workflow project with Agent Kernel components
accepts_args: true
arg_schema:
  - name: project-name
    required: true
    description: "Name for the new project (kebab-case)"
  - name: type
    required: false
    description: "Project type: website, python, lambda, api"
  - name: spoke
    required: false
    description: "Create as separate repo (spoke pattern)"
    flag: true

# Agent Kernel Protocol (Principle #29)
domain: project_scaffolding
tuple_binding:
  slot: Strategy
  effect: initialize
local_check: "Project created with structure, Agent Kernel components, and type-specific configuration"
entities:
  - project
  - structure
  - template
